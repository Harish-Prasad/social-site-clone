...
<div class="modal fade" id="updateModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form class="form-signin" action="EditServlet"  method="post" name="regform">
        <input type="text" value=<%= fname %> class="form-control" placeholder="First name" name="fname" required autofocus/>
        <br>
        <input type="text" value=<%= sname %> class="form-control" placeholder="Surname" name="sname"/>
        <br>
        <input type="hidden" value=<%= email %> class="form-control" placeholder="Email address" name="email"  />
        <br>
        <input type="password" value=<%= password %> class="form-control" placeholder="Password" name="password" required>
         <br>
        <input type="number" value=<%= phoneno %> id="phn" class="form-control" placeholder="Phone number" name="phone" maxlength="10" required>
      </div>
      <div class="modal-footer">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="images/5.jpg" alt="Second slide">
            <div class="container">
