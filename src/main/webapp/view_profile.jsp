...
<body>    
	...
	<div style = "padding:10">
      ...
      if(res.next()){
    	  out.println("<center><br>Name : "+res.getString(1));
    	  out.println("<br>Surname : "+res.getString(2));
    	  out.println("<br>Email : "+res.getString(3));
    	  out.println("<br>Password : "+res.getString(4));
    	  out.println("<br>Phone number : "+res.getString(5));
    	  out.println("<br>Id : "+res.getString(6));
    	  out.println("<br>User id : "+res.getString(7));
    	  out.println("<br>User password : "+res.getString(8)+"</center>");  
      }
      %>
      </div>
